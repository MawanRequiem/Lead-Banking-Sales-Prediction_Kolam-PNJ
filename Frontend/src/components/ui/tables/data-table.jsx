        ...
        <div className="flex items-center space-x-2">
          ...
          {showSearch ? (
            <>
              ...
              {!renderViewOptions ? <DataTableViewOptions table={table} /> : null}
            </>
          ) : (
            !renderViewOptions ? <DataTableViewOptions table={table} /> : null
          )}
        ...
        <Table>
          <TableHeader>
            {table.getHeaderGroups().map((headerGroup) => (
              <TableRow key={headerGroup.id} className="bg-background-secondary hover:bg-background-secondary">
                ...
                {renderRowActions ? <TableHead key="_actions">Aksi</TableHead> : null}
              </TableRow>
            ))}
          </TableHeader>
          <TableBody>
      ...
      <div className="mt-2">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="text-sm">{table.getState().pagination.pageIndex + 1} / {table.getPageCount()}</div>
