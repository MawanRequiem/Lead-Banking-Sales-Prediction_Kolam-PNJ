...
export function MarriageBadge({ value }) {
  ...
  return <Badge className={`px-2 py-1 rounded-full text-xs font-semibold ${className}`}>{v}</Badge>
}
...
export function CallResultBadge({ result }) {
  ...
  return <Badge className={`px-2 py-1 rounded-full text-xs font-semibold ${className}`}>{r}</Badge>
}
